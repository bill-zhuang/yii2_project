...
/**
 * ZhihuHotCollectionSearch represents the model behind the search form about `backend\models\ZhihuHotCollection`.
 */
class ZhihuHotCollectionSearch extends ZhihuHotCollection
{
    /**
     * @inheritdoc
     */
